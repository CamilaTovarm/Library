    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DaysMin = table.Column<int>(type: "int", nullable: false),
                    DaysMax = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AuthorVsBookId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    AuthorId = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorVsBooks", x => x.AuthorVsBookId);
                    table.ForeignKey(
                        name: "FK_AuthorVsBooks_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuthorVsBooks_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanId = table.Column<int>(type: "int", nullable: false),
                    FineImposed = table.Column<float>(type: "real", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    State = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorVsBooks_AuthorId",
                table: "AuthorVsBooks",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthorVsBooks_BookId",
                table: "AuthorVsBooks",
                column: "BookId");
